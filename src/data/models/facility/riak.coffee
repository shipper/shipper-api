...
schema.addField(name: "location.key", type: 'string', indexed: 'true', stored: 'true', multiValued: 'false', required: 'true' )
schema.addField(name: "group.key", type: 'string', indexed: 'true', stored: 'true', multiValued: 'false', required: 'true' )
